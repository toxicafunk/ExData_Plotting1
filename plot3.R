...
### We plot the first sub metering to the default color, then add the other two lines and finally add the legend
...
legend("topright", pch = "_", lwd = 2, col = c("black", "blue", "red"), legend = c("Sub_metering_1", "Sub_metering_2", "Sub_metering_3"))
